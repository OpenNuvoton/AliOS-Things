...
GLOBAL_DEFINES += NUMICRO_M487 STDIO_UART=0 STDIO_UART_BUADRATE=115200
...
#GLOBAL_DEFINES += CONFIG_NETM_FLOW_CONTROL
$(NAME)_COMPONENTS  += sal sal.wifi.esp8266_aos
...
GLOBAL_LDFLAGS += --config board/numaker-iot-m487/M487.icf
else
